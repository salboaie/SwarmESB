...
exports.init = function(sf){
    ...
    function createDebugRecord(level, type, message, exception, saveStack, args, pos){
    var ret = {
            level: level,
            type:type,
    ...
    sf.logger.addCase('hardError', function(message, exception){
        sf.logger.record(createDebugRecord(0, 'systemError', message, exception, true));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('error', function(message, exception){
        sf.logger.record(createDebugRecord(1, 'error', message, exception, true));
    }, [
        {
            'message':'explanation'
        },
    ...
    sf.logger.addCase('logError', function(message, exception){
        sf.logger.record(createDebugRecord(2, 'logError', message, exception, true));
    }, [
        {
            'message':'explanation'
        },
    ...
    sf.logger.addCase('warning', function(message){
        sf.logger.record(createDebugRecord(4, 'warning', message,null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('info', function(message){
        sf.logger.record(createDebugRecord(5, 'info', message,null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('debug', function(message){
        sf.logger.record(createDebugRecord(6, 'debug', message,null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('ldebug', function(message){
        sf.logger.record(createDebugRecord(7, 'ldebug', message, null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('udebug', function(message){
        sf.logger.record(createDebugRecord(8, 'udebug', message ,null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
    ...
    sf.logger.addCase('devel', function(message){
        sf.logger.record(createDebugRecord(9, 'devel', message, null, false, arguments, 1));
    }, [
        {
            'message':'explanation'
        }
